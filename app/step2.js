...
var renderSomethingOnThePage = function(message) {
   ...
   *
   * This also allows us to space out the html as we're used to - a tree.
   */
  var html = [
    "<div>",
      "<span>",
...
var Message = Backbone.Model.extend({  
  ...
  initialize: function(){
     ...
     */
    this.on(/* Write your own event handler here: */);
    /* It is your turn to write the event handler.
     *
     * Make an event listener that will listen for a `change` in this model,
     * then call the method we defined above (`renderSomethingOnThePage`)
     * and pass the message attribute on the model as an argument.
     *
  ...
  alertThisMessage: function() {
    /* Note: The object within any model is a spot you will frequently be
     * storing information about a model in, hence the use of getters/setters.
